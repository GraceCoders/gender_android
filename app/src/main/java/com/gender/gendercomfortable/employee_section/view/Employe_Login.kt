...
import kotlinx.android.synthetic.main.activity_employe__login.*

class Employe_Login : AppCompatActivity(), View.OnClickListener{

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_employe__login)
        initView()
    }
    ...
    override fun onClick(v: View?) {
        when(v?.id)
        {
            ...
            R.id.ll_signup ->
            {
                val i = Intent(this, Employe_Signup::class.java)
                startActivity(i)
            }
            R.id.tv_fgt_pwd ->
            {
                val i = Intent(this, Employee_Forget_Password::class.java)
                startActivity(i)
            }
