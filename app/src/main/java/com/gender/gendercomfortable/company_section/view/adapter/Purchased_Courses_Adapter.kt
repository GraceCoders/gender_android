...
class Purchased_Courses_Adapter(
    val activity: FragmentActivity?
): RecyclerView.Adapter<Purchased_Courses_Adapter.MyViewHolderFav>() {
    var image:String?=null
    var onItemClick: ((pos: Int, view: View) -> Unit)? = null

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolderFav {
        return MyViewHolderFav(LayoutInflater.from(activity).inflate(R.layout.item_purchased_courses, parent, false))
    }
